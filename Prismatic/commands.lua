...
local t = Def.ActorFrame {
	...
	-- For reference: FPC is used for an ongoing Full Perfect Combo, FFC for a Full Flawless Combo, FC for an ongoing Full Great Combo
	-- and Normal is for when a combo break has occured at least once.
	Def.BitmapText{
        File = folderLocation .. "FFC.ini",
		Name="NumberFFC",
		OnCommand = function(self)
            self:vertalign(1):y(0)
        end,
	},
	...
	Def.BitmapText{
		...
		Name="NumberRegular",
		OnCommand = function(self)
            self:vertalign(1):y(0):zoom(2):strokecolor(Color.Black)
        end,
	},
	LoadActor("Label FFC") .. {
		Name="LabelFFC";
